...
source_pic_root_path = r"F:\dataset\images_ori4"  # 原图所在文件夹路径
source_xml_root_path = r"F:\dataset\Annotations_ori4"  # 原XML文件所在文件夹路径
img_save_path = "F:/dataset/images_aug8/"  # 新图片存储路径
save_dir = r"F:\dataset\Annotations_aug8"  # 新xml存储路径
# 如果保存文件夹不存在就创建
