...
int sign = 2;                          // This is the class prediction of the model
int x_mid;
int x_mid_temp;
...
int main(void)
{
    ...
    yolo_region_layer_init(&r1, 0.85, 125, 0, 5);    // init nms rules
...
//                sign = s[t].class;
//                lcd_draw_rectangle(_x1, _y1, _x2, _y2);
//                x_mid_temp = (_x1+_x2)*0.5;
//                if((x_mid_temp - x_mid)<100 ||(x_mid_temp - x_mid)> -100)
//                {
//                    x_mid = x_mid_temp;
//                }
//                uart_send();
