...
int ali_mqtt_init(void)
{
    ...
    tid = rt_thread_create("ali.main",mqtt_example_main,RT_NULL, 8 * 1024, RT_THREAD_PRIORITY_MAX / 2, 10);
    if(tid != RT_NULL){
...
MSH_CMD_EXPORT_ALIAS(ali_mqtt_init, ali_mqtt_sample, ali coap sample);
#endif
